            ...
            <div class="w-3/4 pl-10">
                <div class="flex bg-gray-100 rounded-xl pt-8 pb-8">
                    ...
                    <div class="w-1/2 px-8">
                        ...
                        <p class="text-2xl font-bold">${{ item.saleprice }} <del class="font-normal text-gray-400">${{ regularprice }}</del></p>
                        <div class="flex my-6">
                            <div class="mr-8 flex">
                        ...
                        <div class="text-xs leading-loose">
                            ...
                            <p>
                                ...
                                <nuxt-link class="bs-dark-green-color" :to="'category/' + cat.name">{{cat.name}}</nuxt-link>
                                    <span class="comma" v-if="index == categories.length - 1"> </span>
                            ...
                            <p>
                                ...
                                <span v-for="(tag, index) in tags" :key="index">
                                    ...
                                    <span class="comma" v-if="index == tags.length - 1"></span>
                                    <span class="comma" v-else>, </span>
                                </span>
                            </p>
                        </div>
...
import DemoProducts from "../assets/demo-prods.json";
  export default {
      ...
      //   const DemoProducts = await fetch(
      //     'https://knfm.edu.bd/bengalshop/demo-prods.json'
      //     ).then((res) => res.json())

      const DemoProduct = DemoProducts.find(
        (el) =>
            el.name.replaceAll(' ', '-').toLowerCase() === params.slug
        )
        if (DemoProduct) {
          return {
              item: {
              ...
              regularprice: DemoProduct.regularprice,
              categories: DemoProduct.categories,
